...
Begin VB.Form frmMapProperties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   3
         ItemData        =   "frmMapProperties.frx":106A
         Left            =   -74880
         List            =   "frmMapProperties.frx":106C
         Style           =   2  'Dropdown List
         TabIndex        =   12
         Top             =   1800
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   7
         ItemData        =   "frmMapProperties.frx":106E
         Left            =   -74880
         List            =   "frmMapProperties.frx":1070
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   3240
         Width           =   4095
      ...
      Begin VB.ComboBox cmbNpc 
         ...
         Height          =   315
         Index           =   13
         ItemData        =   "frmMapProperties.frx":1072
         Left            =   -74880
         List            =   "frmMapProperties.frx":1074
         Style           =   2  'Dropdown List
         TabIndex        =   2
         Top             =   5400
         Width           =   4095
