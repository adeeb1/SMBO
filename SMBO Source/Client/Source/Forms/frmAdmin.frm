...
Begin VB.Form frmAdmin 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(6)=   "btnSetThunder"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "btnSetRain"
...
Private Sub btnEditMap_Click()
    ...
    Else
        Call AddText("You don't have a high enough access to do this!", BLACK)
    End If
End Sub
...
Private Sub btnWarpTo_Click()
    If GetPlayerAccess(MyIndex) >= ADMIN_MAPPER Then
        If Len(txtMap.Text) <> 0 Then
            ...
            Else
                Call AddText("You're already on this map!", BLACK)
            End If
        End If
    Else
        Call AddText("You don't have a high enough access to do this!", BLACK)
...
Private Sub PlayerInfo_Click()
    If GetPlayerAccess(MyIndex) >= ADMIN_MAPPER Then
        If LenB(txtPlayerName) <> 0 Then
            Call SendData(CPackets.Cgetstats & SEP_CHAR & txtPlayerName.Text & END_CHAR)
        End If
    Else
        Call AddText("You don't have a high enough access to do this!", BLACK)
    End If
        ...
        If LenB(txtPlayerName.Text) <> 0 Then
            If LenB(txtValue.Text) <> 0 Then
                If Val(txtValue.Text) < 0 Or Val(txtValue.Text) > 5 Then
                    Call AddText("The access range is between 0 and 5.", BLACK)
                Else
...
Private Sub btnSetNone_Click()
  If GetPlayerAccess(MyIndex) > 1 Then
    Call SendData(CPackets.Cweather & SEP_CHAR & 0 & END_CHAR)
  Else
    Call AddText("You don't have a high enough access to do this!", BLACK)
  End If
End Sub
...
Private Sub btnSetRain_Click()
  If GetPlayerAccess(MyIndex) > 1 Then
    Call SendData(CPackets.Cweather & SEP_CHAR & 1 & END_CHAR)
  Else
    Call AddText("You don't have a high enough access to do this!", BLACK)
  End If
End Sub
...
Private Sub btnSetSnow_Click()
  If GetPlayerAccess(MyIndex) > 1 Then
    Call SendData(CPackets.Cweather & SEP_CHAR & 2 & END_CHAR)
  Else
    Call AddText("You don't have a high enough access to do this!", BLACK)
  End If
End Sub
...
Private Sub btnSetThunder_Click()
  If GetPlayerAccess(MyIndex) > 1 Then
    Call SendData(CPackets.Cweather & SEP_CHAR & 3 & END_CHAR)
  Else
    Call AddText("You don't have a high enough access to do this!", BLACK)
  End If
End Sub
