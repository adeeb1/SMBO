...
Begin VB.Form frmPlayerChat 
   ...
   Begin RichTextLib.RichTextBox txtChat 
      ...
      ReadOnly        =   -1  'True
      Appearance      =   0
      TextRTF         =   $"frmPlayerChat.frx":75E54
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    ...
    If (KeyAscii = vbKeyReturn) Then
        ...
        txtChat.SelColor = QBColor(BLUE)
        txtChat.SelText = s
        txtChat.SelStart = Len(txtChat.Text) - 1

        Call SendData(CPackets.Csendchat & SEP_CHAR & txtSay.Text & END_CHAR)
        txtSay.Text = vbNullString
    End If
End Sub

Private Sub Label2_Click()
    Call SendData(CPackets.Cqchat & END_CHAR)
End Sub
