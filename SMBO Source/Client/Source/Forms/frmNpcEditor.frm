...
Begin VB.Form frmNpcEditor 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.HScrollBar scrlLevel 
         ...
         Width           =   1695
      End
      Begin VB.TextBox txtAttackSay2 
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   6.75
            Charset         =   0
...
Private Sub BigNpc_Click()
    ...
    If BigNpc.Value = Checked Then
        Call InitLoadPicture(App.Path & "\GFX\BigSprites.smbo", picSprites)
        ...
        picSprite.Top = 2260
    Else
        Call InitLoadPicture(App.Path & "\GFX\Sprites.smbo", picSprites)
...
Private Sub scrlLevel_Change()
    lblLevel.Caption = CStr(scrlLevel.Value)
End Sub
